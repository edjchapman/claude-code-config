...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- |
| `@bug-resolver`         | Run a bug investigation in its own context, with project memory and issue-tracker lookup, and report a root cause with proposed fixes. Use when an investigation should be dispatched separately from the current work; to diagnose in-context, use the diagnosing-bugs skill. | `inherit` |
...
| `@performance-engineer` | Profile and optimize application performance — bottlenecks, slow queries, memory and CPU, caching. Use for planned optimization, load-testing, and scalability work; for a performance regression that needs diagnosing, use the diagnosing-bugs skill.                        | `inherit` |
...
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| `/adr`           | Record a technical decision as an Architecture Decision Record. Use when weighing a framework, library, database, or schema-migration trade-off, or when asked for an ADR.                                                            | you or Claude              |
